describe('Cart features', () => {
    ...
    it('can add a plate to the cart', () => {
        ...
        cy.contains("Home").click();
        cy.contains(`app-license-plate`, "California").contains('Add to cart').click();
    ...
    it('can remove a plate from the cart', () => {
        ...
        cy.contains("Home").click();
        cy.contains(`app-license-plate`, "California").contains('Add to cart').click();
        cy.contains('Plate added to cart').should('be.visible');
        ...
        cy.get(`app-license-plate`).should('length', 0);
